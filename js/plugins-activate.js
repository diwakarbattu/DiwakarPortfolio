...
$(document).ready(function () {
          ...
          i = [].slice
            ...
            .map(function (t) {
              ...
              return (
                ...
                (t.h = e.bottom - e.top),
                (t.fX =
                  t.getAttribute("data-force-x") ||
                  t.getAttribute("data-force") ||
                  10),
                (t.fY =
                  t.getAttribute("data-force-y") ||
                  t.getAttribute("data-force") ||
                  10),
                t
              );
          ...
          (function o() {
            if (t && e) {
              ...
              i.forEach(function (t) {
                var e = (t.w / t.fX) * (l / -s),
                  n = (t.h / t.fY) * (u / c);
                t.style.transform = t.style["-webkit-transform"] =
                  "translate(" + e + "px," + n + "px)";
              });
            }
            n(o);
      ...
      (function () {
        ...
        function e() {
          ...
          function o(t) {
            t.preventDefault(),
              t.stopPropagation(),
              (c = parseInt(t.clientX - d)),
              (l = parseInt(t.clientY - f)),
              (m.length = 0),
              m.push({
                x: c,
                y: l,
  ...
  $("#fc-slideshow").flipshow(),
    ...
    $(
      "#cf_menu a, .button, .view-works, ul.fc-slides li a, .download-resume-cta, #ToggleNav li a "
    ).click(function (t) {
      t.preventDefault(),
        $(
          "#cf_menu a, button, .view-works, ul.fc-slides li a, .download-resume-cta, #ToggleNav li a"
  ...
  setInterval(function () {
    jQuery("#seconds").html(t(++o % 60)),
      jQuery("#minutes").html(t(parseInt(o / 60, 10)));
  }, 1e3),
    $(function () {
      $.scrollUp({
        scrollName: "scrollUp",
  ...
  (function (t) {
    function e() {
      var t = document.createElement("div"),
        e = "";
      return (
        "WebkitTransition" in t.style
          ? (e = "-webkit-")
          : "MozTransition" in t.style && (e = "-moz-"),
        e
      );
    }
    ...
    function n(e) {
      (this.$elt = t(
        ...
        (this.scale = 0.3 * Math.random() + 0.1),
        this.$wings.css("animation-duration", 2 * this.scale + "s"),
        (this.x = Math.random() * t(document).width()),
        (this.y = Math.random() * t(document).height()),
        (this.vx = 10 * Math.random() - 5),
        (this.vy = 10 * Math.random() - 5),
        (this.l = 20 * this.scale),
    ...
    (n.prototype.move = function () {
      ...
      this.vy < 0 && (n = 180 - n),
        (i += "rotateZ(" + Math.round(n) + "deg)"),
        (this.x += this.vx),
        (this.y += this.vy);
      var o = "";
      return (
        (o += s + "transform:" + i + ";"),
        (o += "left:" + Math.round(this.x) + "px;"),
        (o += "top:" + Math.round(this.y) + "px;"),
        (this.elt.style.cssText = o),
        this
      );
    }),
      (n.prototype.setDestination = function (t, e) {
        var n = t - this.x,
          ...
          o = Math.sqrt(n * n + i * i);
        return (
          (this.vx = this.vx + (0.4 * n) / o),
          (this.vy = this.vy + (0.4 * i) / o),
          this.limit().move(),
          this
        );
      }),
      (n.prototype.limit = function () {
        var t = this.l;
        return (
          this.vx > t ? (this.vx = t) : this.vx < -t && (this.vx = -t),
          this.vy > t ? (this.vy = t) : this.vy < -t && (this.vy = -t),
          this
        );
      }),
        ...
        t(document).on("mousemove", function (t) {
          ...
          t(document).on("click", function () {
            for (var t = 0; t < o.length; t++)
              (o[t].vx = 40 - 80 * Math.random()),
                (o[t].vy = 40 - 80 * Math.random());
          }),
          setInterval(function () {
            i();
          }, 40);

(window.Modernizr = (function (t, e, i) {
  ...
  function a(t, e, o) {
    for (var n in t) {
      var s = e[t[n]];
      if (s !== i)
        return o === !1 ? t[n] : r(s, "function") ? s.bind(o || e) : s;
    }
    return !1;
  }
  ...
  var c,
    ...
    _ = {}.hasOwnProperty;
  (u =
    r(_, "undefined") || r(_.call, "undefined")
      ? function (t, e) {
  ...
  for (var M in S)
    u(S, M) &&
      ((h = M.toLowerCase()), (p[h] = S[M]()), T.push((p[h] ? "" : "no-") + h));
  return (
    (p.addTest = function (t, e) {
      if ("object" == typeof t) for (var o in t) u(t, o) && p.addTest(o, t[o]);
      else {
    ...
    (function (t, e) {
      ...
      function n(t, i, o) {
        ...
        return (
          (n = o.cache[t]
            ...
            : o.createElem(t)),
          n.canHaveChildren && !d.test(t) ? o.frag.appendChild(n) : n
        );
      }
      ...
      function s(t, i) {
        ...
        i = i || r(t);
        for (
          var n = i.frag.cloneNode(), s = 0, a = o(), l = a.length;
          l > s;
          s++
        )
          n.createElement(a[s]);
  ...
  (function (t, e, i) {
    ...
    function l(t, i, o, r, n, l, c) {
      ...
      1 === C[i] && ((g = 1), (C[i] = [])),
        ...
        "img" != t &&
          (g || 2 === C[i]
            ? (b.insertBefore(u, x ? null : m), f(h, c))
            : C[i].push(u));
    }
    ...
    (d = function (t) {
      function e(t) {
        ...
        for (i = 0; s > i; i++)
          (o = t[i].split("=")), (e = _[o.shift()]) && (n = e(n, o));
      ...
      if (r(t)) s(t, 0, u, 0);
        ...
        for (l = 0; l < t.length; l++)
          (c = t[l]),
            r(c) ? s(c, 0, u, 0) : T(c) ? d(c) : Object(c) === c && a(c, u);
      ...
      (t.yepnope.injectJs = function (t, i, o, r, l, c) {
        var h,
          u,
  ...
  (function (t) {
    ...
    if (!a)
      for (var c in s) {
        var h = s[c];
        a || (a = window[h + "RequestAnimationFrame"]),
          l ||
            (l =
    ...
    var u = window.MutationObserver || window.WebKitMutationObserver || !1,
      ...
      f = function () {
        ...
        (e.isopera = "opera" in window),
          ...
          (e.isie7mobile =
            !e.isie9mobile && e.isie7 && /iemobile/i.test(navigator.userAgent)),
          ...
          (e.isios =
            e.cantouch && /iphone|ipad|ipod/i.test(navigator.platform)),
      ...
      m = function (s, c) {
        ...
        function m(t, e, i, o) {
          y._bind(
            ...
            function (o) {
              ...
              return (
                "mousewheel" == e
                  ? ((r.deltaY = -0.025 * o.wheelDelta),
                    o.wheelDeltaX && (r.deltaX = -0.025 * o.wheelDeltaX))
                  : (r.deltaY = o.detail),
                i.call(t, r)
              );
            },
        ...
        function v(t, e, i) {
          ...
          if (
            (0 == t.deltaMode
              ? ((o = -Math.floor(t.deltaX * (y.opt.mousescrollstep / 54))),
                (r = -Math.floor(t.deltaY * (y.opt.mousescrollstep / 54))))
              : 1 == t.deltaMode &&
                ((o = -Math.floor(t.deltaX * y.opt.mousescrollstep)),
                (r = -Math.floor(t.deltaY * y.opt.mousescrollstep))),
            e && y.opt.oneaxismousemode && 0 == o && r && ((o = r), (r = 0)),
            o &&
        ...
        (this.iddoc =
          (this.doc = y.opt.doc) && this.doc[0] ? this.doc[0].id || "" : ""),
          (this.ispage = /^BODY|HTML/.test(
            y.opt.win ? y.opt.win[0].nodeName : this.doc[0].nodeName
          )),
          (this.haswrapper = !1 !== y.opt.win),
          (this.win = y.opt.win || (this.ispage ? t(window) : this.doc)),
          (this.docscroll =
            this.ispage && !this.haswrapper ? t(window) : this.win),
          (this.body = t("body")),
        ...
        (this.ishwscroll =
          (this.canhwscroll = x.hastransform && y.opt.hwacceleration) &&
          y.haswrapper),
        ...
        (this.getOffset = function () {
          ...
          (this.updateScrollBar = function (t) {
            if (y.ishwscroll)
              ...
              var o =
                  ...
                  (y.rail.align
                    ? y.win.outerWidth() -
                      p(y.win, "border-right-width") -
                      y.rail.width
                    : p(y.win, "border-left-width")),
                r = y.opt.railoffset;
              r &&
                (r.top && (i += r.top),
                y.rail.align && r.left && (o += r.left)),
                y.locked ||
                  y.rail.css({
                    top: i,
                    left: o,
                ...
                y.railh &&
                  ...
                  (t = y.railh.align
                    ? i +
                      p(y.win, "border-top-width", !0) +
                      y.win.innerHeight() -
                      y.railh.height
                    : i + p(y.win, "border-top-width", !0)),
                  (o += p(y.win, "border-left-width")),
                  y.railh.css({
                    top: t,
                    left: o,
                    width: y.railh.width,
          ...
          (this.doRailClick = function (t, e, i) {
            ...
            y.locked ||
              (y.cancelEvent(t),
              e
                ? ((e = i ? y.doScrollLeft : y.doScrollTop),
                  (o = i
                    ? (t.pageX - y.railh.offset().left - y.cursorwidth / 2) *
                      y.scrollratio.x
                    : (t.pageY - y.rail.offset().top - y.cursorheight / 2) *
                      y.scrollratio.y),
                  e(o))
                : ((e = i ? y.doScrollLeftBy : y.doScrollBy),
                  (o = i ? y.scroll.x : y.scroll.y),
                  (t = i
                    ? t.pageX - y.railh.offset().left
                    : t.pageY - y.rail.offset().top),
                  (i = i ? y.view.w : y.view.h),
                  e(o >= t ? i : -i)));
          }),
            ...
            if (
              ...
              (y.zindex =
                y.ispage || "auto" != y.opt.zindex
                  ? y.opt.zindex
                  : h() || "auto"),
              !y.ispage && "auto" != y.zindex && y.zindex > n && (n = y.zindex),
              y.isie &&
                0 == y.zindex &&
                "auto" == y.opt.zindex &&
                (y.zindex = "auto"),
              ...
              for (d in p)
                (c = p[d]),
                  (l = y.opt.railpadding[c])
                    ? a.css("padding-" + c, l + "px")
                    : (y.opt.railpadding[c] = 0);
              if (
                (a.append(s),
                (a.width =
                  Math.max(parseFloat(y.opt.cursorwidth), s.outerWidth()) +
                ...
                (a.visibility = !0),
                (a.scrollable = !0),
                (a.align = "left" == y.opt.railalign ? 0 : 1),
                (y.rail = a),
                (s = y.rail.drag = !1),
                y.opt.boxzoom &&
                  !y.ispage &&
                  ...
                  x.cantouch &&
                    ...
                    ((y.ongesturezoom = function (t) {
                      return (
                        1.5 < t.scale && y.doZoomIn(t),
                        0.8 > t.scale && y.doZoomOut(t),
                        y.cancelEvent(t)
                      );
                    }),
                ...
                f.attr("id", y.id + "-hr"),
                  ...
                  (f.visibility = !0),
                  (f.scrollable = !0),
                  (f.align = "top" == y.opt.railvalign ? 0 : 1),
                  (y.railh = f),
                  (y.railh.drag = !1);
              }
              if (
                (y.ispage
                  ...
                  : (y.ishwscroll
                      ? ("static" == y.win.css("position") &&
                        ...
                        (r = "HTML" == y.win[0].nodeName ? y.body : y.win),
                        y.zoom &&
                          (y.zoom.css({
                            position: "absolute",
                            top: 1,
                ...
                (y.scrollmom = new g(y)),
                  (y.onmangotouch = function (t) {
                    t = y.getScrollTop();
                    var e = y.getScrollLeft();
                    if (
                      t == y.scrollmom.lastscrolly &&
                      e == y.scrollmom.lastscrollx
                    )
                      return !0;
                    ...
                    if (
                      0 !=
                      Math.round(Math.sqrt(Math.pow(o, 2) + Math.pow(i, 2)))
                    ) {
                      var r = 0 > i ? -1 : 1,
                        n = 0 > o ? -1 : 1,
                        s = +new Date();
                      y.mangotouch.lazy && clearTimeout(y.mangotouch.lazy),
                        80 < s - y.mangotouch.tm ||
                        y.mangotouch.dry != r ||
                        y.mangotouch.drx != n
                          ? (y.scrollmom.stop(),
                ...
                if (
                  ...
                  var m =
                    y.opt.touchbehavior && y.isiframe && !x.hasmousecapture;
                  y.ontouchmove = function (e, i) {
                    if (e.pointerType && 2 != e.pointerType) return !1;
                    if (y.rail.drag && 2 == y.rail.drag.pt) {
                      if (x.cantouch && "undefined" == typeof e.original)
                        return !0;
                      if (
                        ((y.hasmoving = !0),
                        y.preventclick &&
                      ...
                      if (
                        (y.ishwscroll && y.opt.bouncescroll
                          ? 0 > l
                            ...
                            : l > y.page.maxh &&
                              (l =
                                y.page.maxh + Math.round((l - y.page.maxh) / 2))
                          : (0 > l && (n = l = 0),
                            l > y.page.maxh && ((l = y.page.maxh), (n = 0))),
                        ...
                        y.ishwscroll && y.opt.bouncescroll
                          ? 0 > c
                            ...
                            : c > y.page.maxw &&
                              (c =
                                y.page.maxw + Math.round((c - y.page.maxw) / 2))
                          : (0 > c && (s = c = 0),
                            c > y.page.maxw && ((c = y.page.maxw), (s = 0)));
                      }
                      if (((o = !1), y.rail.drag.dl))
                        (o = !0),
                          "v" == y.rail.drag.dl
                            ? (c = y.rail.drag.sl)
                            : "h" == y.rail.drag.dl && (l = y.rail.drag.st);
                      else {
                        var r = Math.abs(r),
                          a = Math.abs(a),
                      ...
                      if (
                        (y.synched("touchmove", function () {
                          y.rail.drag &&
                            ...
                            y.rail.scrollable && y.setScrollTop(l),
                            y.scrollmom.update(s, n),
                            y.railh && y.railh.scrollable
                              ? (y.setScrollLeft(c), y.showCursor(l, c))
                              : y.showCursor(l),
                            x.isie10 && document.selection.clear());
                        }),
                        x.ischrome && y.istouchcapable && (o = !1),
                        o)
                      )
                  ...
                  (y.onmousemove = function (t) {
                    if (y.rail.drag && 1 == y.rail.drag.pt) {
                      ...
                      if (
                        ...
                        (y.scroll.x =
                          y.rail.drag.sx + (t.clientX - y.rail.drag.x)),
                          0 > y.scroll.x && (y.scroll.x = 0);
                        var e = y.scrollvaluemaxw;
                        y.scroll.x > e && (y.scroll.x = e);
                      } else
                        (y.scroll.y =
                          y.rail.drag.sy + (t.clientY - y.rail.drag.y)),
                          0 > y.scroll.y && (y.scroll.y = 0),
                          (e = y.scrollvaluemax),
                          y.scroll.y > e && (y.scroll.y = e);
                      return (
                    ...
                    (y.onclick = x.isios
                      ...
                      : function (t) {
                          return y.lastmouseup
                            ? ((y.lastmouseup = !1), y.cancelEvent(t))
                            : !0;
                        }),
                  ...
                  var v = function (t) {
                    if (y.selectiondrag) {
                      if (t) {
                        ...
                        (t = t.pageY - y.selectiondrag.top),
                          t > 0 && e > t && (t = 0),
                          t >= e && (t -= e),
                          (y.selectiondrag.df = t);
                      }
                ...
                x.hasmstouch &&
                  ...
                  x.cantouch || y.opt.touchbehavior
                    ? (y.bind(
                        x.hasmousecapture ? y.win : document,
                        "mouseup",
                        y.ontouchend
                      ),
                  ...
                  y.opt.enablemousewheel &&
                    (y.isiframe ||
                      y.bind(
                        x.isie && y.ispage ? document : y.win,
                        "mousewheel",
                        y.onmousewheel
                      ),
              ...
              if (
                ((y.onkeypress = function (o) {
                  ...
                  if (
                    ...
                    if (((r = o.keyCode), y.locked && 27 != r))
                      return y.cancelEvent(o);
                    var n = o.ctrlKey || !1,
                      s = o.shiftKey || !1,
                      a = !1;
                    switch (r) {
                      ...
                      case 32:
                        y.opt.spacebarenabled &&
                          (y.doScrollBy(s ? y.view.h : -y.view.h), (a = !0));
                        break;
                      case 27:
                ...
                y.bind(document, "keydown", function (t) {
                ...
                return y.iframexd
                  ...
                  : ((y.forcescreen = !0),
                    y.isiframe &&
                      ...
                      (y.docscroll = t(y.iframe.body))),
                    !x.isios &&
                      y.opt.iframeautoresize &&
                      !y.isiframe &&
                      (y.win.scrollTop(0),
                      y.doc.height(""),
                      (e = Math.max(
                        i.getElementsByTagName("html")[0].scrollHeight,
                        i.body.scrollHeight
                      )),
                      y.doc.height(e)),
                    y.lazyResize(30),
                    x.isie7 &&
                      y.css(t(y.iframe.html), {
                        "overflow-y": "hidden",
                      }),
                    ...
                    "contentWindow" in this
                      ...
                      : y.bind(i, "scroll", y.onscroll),
                    y.opt.enablemousewheel &&
                      y.bind(i, "mousewheel", y.onmousewheel),
                    y.opt.enablekeyboard &&
                      y.bind(
                        i,
                        x.isopera ? "keypress" : "keydown",
                        y.onkeypress
                      ),
                    (x.cantouch || y.opt.touchbehavior) &&
                      (y.bind(i, "mousedown", y.ontouchstart),
                      y.bind(i, "mousemove", function (t) {
                        y.ontouchmove(t, !0);
                      }),
                      y.opt.grabcursorenabled &&
                        x.cursorgrabvalue &&
                    ...
                    y.bind(i, "mouseup", y.ontouchend),
                    void (
                      y.zoom &&
                      (y.opt.dblclickzoom && y.bind(i, "dblclick", y.doZoom),
                      y.ongesturezoom &&
            ...
            y.cursortimeout &&
              ...
              y.rail &&
                ...
                (y.rail.drag && 1 == y.rail.drag.pt) ||
                  ("undefined" != typeof t &&
                    !1 !== t &&
                    (y.scroll.y = Math.round((1 * t) / y.scrollratio.y)),
                  "undefined" != typeof e &&
                    (y.scroll.x = Math.round((1 * e) / y.scrollratio.x))),
                y.cursor.css({
          ...
          (this.onResize = function (t, e) {
            ...
            if (
              ...
              y.page.maxh == i && y.page.maxw == o && y.view.w == r)
            ) {
              if (y.ispage) return y;
              if (
                ((i = y.win.offset()),
                y.lastposition &&
                  ((o = y.lastposition), o.top == i.top && o.left == i.left))
              )
                return y;
              y.lastposition = i;
            }
            return (
              ...
              y.locked
                ...
                : (y.hidden || y.visibility
                  ...
                  (y.scrollvaluemax =
                    y.view.h - y.cursorheight - y.cursor.hborder),
                  y.railh &&
                    ((y.railh.width =
          ...
          (this.bind = function (t, e, i, o) {
            ...
            "mousewheel" == e
              ...
              ? (x.cantouch &&
                ...
                x.cantouch &&
                  "mouseup" == e &&
                  y._bind(r, "touchcancel", i, o || !1))
              : y._bind(r, e, function (t) {
                  return (
                    (t = t || window.event || !1) &&
                      t.srcElement &&
                    ...
                    !1 === i.call(r, t) || !1 === o ? y.cancelEvent(t) : !0
                  );
                });
          }),
          ...
          (this.getViewport = function (e) {
            for (
              e = e && e.parentNode ? e.parentNode : !1;
              ...
              var o =
                ...
                "";
              if (
                (/scroll|auto/.test(o) && e.clientHeight != e.scrollHeight) ||
                0 < i.getNiceScroll().length
              )
                return i;
              e = e.parentNode ? e.parentNode : !1;
            }
          ...
          (this.onmousewheel = function (t) {
            if (!y.wheelprevented) {
              if (y.locked)
                return y.debounced("checkunlock", y.resize, 250), !0;
              ...
              return (
                y.opt.preservenativescrolling &&
                  y.checkarea + 600 < e &&
                  ((y.nativescrollingarea = y.isScrollable(t)), (i = !0)),
                (y.checkarea = e),
                y.nativescrollingarea
                  ? !0
                  : ((t = v(t, !1, i)) && (y.checkarea = 0), t)
              );
            }
          }),
          ...
          (this.getTransitionSpeed = function (t) {
            ...
            return (
              (t = Math.min(e, Math.round((t / 20) * y.opt.scrollspeed))),
              t > 20 ? t : 0
            );
          }),
          y.opt.smoothscroll
            ? y.ishwscroll && x.hastransition && y.opt.usetransition
              ? ((this.prepareTransition = function (t, e) {
                  var i = e ? (t > 20 ? t : 0) : y.getTransitionSpeed(t),
                    o = i
                      ? x.prefixstyle + "transform " + i + "ms ease-out"
                      : "";
                  return (
                    (y.lasttransitionstyle && y.lasttransitionstyle == o) ||
                      ((y.lasttransitionstyle = o),
                      y.doc.css(x.transitionstyle, o)),
                    i
                  );
                }),
                ...
                (this.doScrollPos = function (t, e, i) {
                  var o = y.getScrollTop(),
                    r = y.getScrollLeft();
                  return (
                    (0 > (y.newscrolly - o) * (e - o) ||
                      0 > (y.newscrollx - r) * (t - r)) &&
                      y.cancelScroll(),
                        ...
                        y.timer
                          ...
                          : void (y.timer = setTimeout(function () {
                              ...
                              (i = t - n),
                                ...
                                (i =
                                  y.newscrollspeed && 1 < y.newscrollspeed
                                    ? y.newscrollspeed
                                    : y.getTransitionSpeed(i)),
                                y.newscrollspeed &&
                                  1 >= y.newscrollspeed &&
                                  (i *= y.newscrollspeed),
                ...
                (this.cancelScroll = function () {
                  ...
                  return (
                    ...
                    y._unbind(y.doc, x.transitionend, y.onScrollTransitionEnd),
                ...
                (this.onScrollTransitionEnd = function () {
                  ...
                  return (
                    ...
                    t != y.newscrolly || e != y.newscrollx
                      ? y.doScrollPos(e, t, y.opt.snapbackspeed)
                      : (y.onscrollend &&
                          y.scrollrunning &&
                          y.triggerScrollEnd(),
              ...
              : ((this.doScrollLeft = function (t, e) {
                ...
                (this.doScrollPos = function (t, e, i) {
                  function o() {
                    ...
                    if (((y.scrollrunning = !0), (u = 1 - u)))
                      return (y.timer = a(o) || 1);
                    var t = 0,
                      e = (sy = y.getScrollTop());
                    if (y.dst.ay) {
                      var e = y.bzscroll
                    ...
                    y.dst.ax
                      ...
                      2 == t
                        ? ((y.timer = 0),
                          ...
                          0 > e
                            ? (e = 0)
                            : e > y.page.maxh && (e = y.page.maxh),
                          0 > r
                            ? (r = 0)
                            : r > y.page.maxw && (r = y.page.maxw),
                          r != y.newscrollx || e != y.newscrolly
                            ? y.doScrollPos(r, e)
                            : y.onscrollend && y.triggerScrollEnd())
                        : (y.timer = a(o) || 1);
                  }
                  if (
                    ((e =
                      "undefined" == typeof e || !1 === e
                        ? y.getScrollTop(!0)
                        : e),
                    y.timer && y.newscrolly == e && y.newscrollx == t)
                  )
                    return !0;
                  y.timer && l(y.timer), (y.timer = 0);
                  var r = y.getScrollTop(),
                    n = y.getScrollLeft();
                  (0 > (y.newscrolly - r) * (e - r) ||
                    0 > (y.newscrollx - n) * (t - n)) &&
                    y.cancelScroll(),
                    (y.newscrolly = e),
                    (y.newscrollx = t),
                  ...
                  if (
                    (0 == y.dst.x
                      ? ((c = r), (h = e), (y.dst.ay = 1), (y.dst.py = 0))
                      : 0 == y.dst.y &&
                        ((c = n), (h = t), (y.dst.ax = 1), (y.dst.px = 0)),
                    (s = y.getTransitionSpeed(s)),
                    i && 1 >= i && (s *= i),
                    (y.bzscroll =
                      s > 0
                        ? y.bzscroll
                          ? y.bzscroll.update(h, s)
                          : new BezierClass(c, h, s, 0, 1, 0, 1)
                        : !1),
                    !y.timer)
                  ) {
                    ((r == y.page.maxh && e >= y.page.maxh) ||
                      (n == y.page.maxw && t >= y.page.maxw)) &&
                      y.checkContentSize();
                    var u = 1;
          ...
          (this.doScrollBy = function (t, e) {
            var i = 0,
              i = e
                ? Math.floor((y.scroll.y - t) * y.scrollratio.y)
                : (y.timer ? y.newscrolly : y.getScrollTop(!0)) - t;
            if (y.bouncescroll) {
          ...
          (this.doScrollLeftBy = function (t, e) {
            var i = 0,
              i = e
                ? Math.floor((y.scroll.x - t) * y.scrollratio.x)
                : (y.timer ? y.newscrollx : y.getScrollLeft(!0)) - t;
            if (y.bouncescroll) {
            ...
            return (
              ...
              (0 > i && 0 >= px) || (i > y.page.maxw && px >= y.page.maxw)
                ? y.noticeCursor()
                : void y.doScrollLeft(i)
            );
          }),
          (this.doScrollTo = function (t, e) {
            e && Math.round(t * y.scrollratio.y),
              (y.cursorfreezed = !1),
              y.doScrollTop(t);
          }),
          ...
          (this.doZoomIn = function (e) {
            if (!y.zoomactive) {
              ...
              return (
                ...
                x.isios4 &&
                  ((y.zoomrestore.scrollTop = t(window).scrollTop()),
          ...
          (this.doZoomOut = function (e) {
            return y.zoomactive
              ? ((y.zoomactive = !1),
                ...
                x.isios4 && t(window).scrollTop(y.zoomrestore.scrollTop),
                y.rail.css({
                  "z-index": y.zindex,
                }),
                y.zoom.css({
        ...
        (this.nc = t),
          ...
          (this.doMomentum = function (t) {
            ...
            var r = e.nc.getScrollTop(),
              ...
              s = e.nc.page.maxw;
            if (
              ((e.speedx = s > 0 ? Math.min(60, e.speedx) : 0),
              (e.speedy = n > 0 ? Math.min(60, e.speedy) : 0),
              (o = o && 60 >= i - o),
              (0 > r || r > n || 0 > t || t > s) && (o = !1),
              ...
              a > 50 &&
                ((t = a / 50), (e.speedx *= t), (e.speedy *= t), (a = 50)),
                (e.demulxy = 0),
                ...
                h = function () {
                  ...
                  e.speedx &&
                    ...
                    e.nc.synched("domomentum2d", function () {
                      e.speedx &&
                        (e.nc.getScrollLeft() != e.chkx && e.stop(),
                        (e.chkx = l),
                        e.nc.setScrollLeft(l)),
                        e.speedy &&
                          (e.nc.getScrollTop() != e.chky && e.stop(),
                          (e.chky = c),
                          e.nc.setScrollTop(c)),
                        e.timer || (e.nc.hideCursor(), e.doSnapy(l, c));
                    }),
                    1 > e.demulxy
                      ? (e.timer = setTimeout(h, a))
                      : (e.stop(), e.nc.hideCursor(), e.doSnapy(l, c));
                };
              h();
    ...
    (t.cssHooks.pageYOffset = {
      get: function (e, i) {
        return (i = t.data(e, "__nicescroll") || !1) && i.ishwscroll
          ? i.getScrollTop()
          : v.call(e);
      },
      set: function (e, i) {
        ...
        return (
          o && o.ishwscroll ? o.setScrollTop(parseInt(i)) : v.call(e, i), this
        );
      },
    }),
    ...
    (t.cssHooks.pageXOffset = {
      ...
      set: function (e, i) {
        var o = t.data(e, "__nicescroll") || !1;
        return (
          o && o.ishwscroll ? o.setScrollLeft(parseInt(i)) : y.call(e, i), this
        );
      },
    }),
    ...
    !(function (t, e, i) {
      ...
      (t.fn.getNiceScroll = function (e) {
        return "undefined" == typeof e
          ? new w(this)
          : (this[e] && t.data(this[e], "__nicescroll")) || !1;
      }),
      t.extend(t.expr[":"], {
      ...
      (t.fn.niceScroll = function (e, i) {
        ...
        "undefined" == typeof i && (i = {}),
          e && ((i.doc = t(e)), (i.win = t(this)));
        var r = !("doc" in i);
        return (
          !r && !("win" in i) && (i.win = t(this)),
          this.each(function () {
            var e = t(this).data("__nicescroll") || !1;
            e ||
              ((i.doc = r ? t(this) : i.doc),
              (e = new m(i, t(this))),
  ...
  (function () {
    function t() {
      if (t.is(arguments[0], H)) {
        for (
          var e = arguments[0],
            i = Ve[y](t, e.splice(0, 3 + t.is(e[0], O))),
            o = i.set(),
            r = 0,
            n = e[M];
          n > r;
    ...
    function o(e, i, o, r, n) {
      return n
        ...
        : t.format("M{0},{1}l{2},0,0,{3},{4},0z", e, i, o, r, -o);
    }
    ...
    function n(e) {
      return function (i, o, r, n) {
        ...
        return (
          t.is(r, "function") ? (n = r) : (s.rot = r),
          i && i.constructor == $e && (i = i.attrs.path),
          i && (s.along = i),
          this.animate(s, o, n)
        );
      };
    ...
    if (
      ...
      var he,
        ue = p.createElement("div");
      if (
        ((ue.innerHTML = '<v:shape adj="1"/>'),
        (he = ue.firstChild),
        (he.style.behavior = "url(#default#VML)"),
        !he || "object" != typeof he.adj)
      )
        return (t.type = null);
      ue = null;
    }
    (t.svg = !(t.vml = "VML" == t.type)),
        ...
        return (
          ...
          "finite" == e
            ...
            : ("null" == e && null === t) ||
              ...
              W.call(t).slice(8, -1).toLowerCase() == e
        );
      }),
      (t.angle = function (e, i, o, r, n, s) {
        if (null == n) {
          var a = e - o,
            l = i - r;
          return a || l
            ? (180 * (0 > a) + (180 * A.atan(-l / -a)) / R + 360) % 360
            : 0;
        }
      ...
      (t.snapTo = function (e, i, o) {
        if (((o = t.is(o, "finite") ? o : 10), t.is(e, H))) {
          for (var r = e.length; r--; ) if (N(e[r] - i) <= o) return e[r];
        } else {
          e = +e;
          var n = i % e;
          if (o > n) return i - n;
        ...
        if (n.vml) {
          ...
          de = i(function (t) {
            try {
              ...
              return (
                (i = ((255 & i) << 16) | (65280 & i) | ((16711680 & i) >>> 16)),
                "#" + ("000000" + i[j](16)).slice(-6)
              );
            } catch (t) {
              return "none";
            }
          ...
          (a.title = "RaphaÃ«l Colour Picker"),
            (a.style.display = "none"),
            p.body[v](a),
            (de = i(function (t) {
              return (
                (a.style.color = t),
                p.defaultView.getComputedStyle(a, b).getPropertyValue("color")
              );
            }));
        }
        return de(t);
    ...
    (t.hsb2rgb = function (e, i, o, r) {
      ...
      (t.hsl2rgb = function (e, i, o, r) {
        ...
        return (
          ...
          (l.hex =
            "#" +
            (16777216 | l.b | (l.g << 8) | (l.r << 16)).toString(16).slice(1)),
          t.is(r, "finite") && (l.opacity = r),
          (l.toString = me),
          l
        );
      }),
      ...
      (t.getRGB = i(function (e) {
        ...
        !(re[d](e.toLowerCase().substring(0, 2)) || "#" == e.charAt()) &&
          (e = de(e));
        var i,
          o,
          r,
        ...
        return l
          ? (l[2] &&
              ((r = V(l[2].substring(5), 16)),
              (o = V(l[2].substring(3, 5), 16)),
              (i = V(l[2].substring(1, 3), 16))),
            l[3] &&
              ((r = V((s = l[3].charAt(3)) + s, 16)),
              (o = V((s = l[3].charAt(2)) + s, 16)),
              (i = V((s = l[3].charAt(1)) + s, 16))),
            l[4] &&
              ((a = l[4][T](oe)),
              (i = U(a[0])),
              "%" == a[0].slice(-1) && (i *= 2.55),
              ...
              (r = U(a[2])),
              "%" == a[2].slice(-1) && (r *= 2.55),
              "rgba" == l[1].toLowerCase().slice(0, 4) && (n = U(a[3])),
              a[3] && "%" == a[3].slice(-1) && (n /= 100)),
            l[5]
              ? ((a = l[5][T](oe)),
                (i = U(a[0])),
                "%" == a[0].slice(-1) && (i *= 2.55),
                ...
                (r = U(a[2])),
                "%" == a[2].slice(-1) && (r *= 2.55),
                ("deg" == a[0].slice(-3) || "Â°" == a[0].slice(-1)) &&
                  (i /= 360),
                "hsba" == l[1].toLowerCase().slice(0, 4) && (n = U(a[3])),
                a[3] && "%" == a[3].slice(-1) && (n /= 100),
                t.hsb2rgb(i, o, r, n))
              : l[6]
              ? ((a = l[6][T](oe)),
                ...
                ("deg" == a[0].slice(-3) || "Â°" == a[0].slice(-1)) &&
                  (i /= 360),
                "hsla" == l[1].toLowerCase().slice(0, 4) && (n = U(a[3])),
                a[3] && "%" == a[3].slice(-1) && (n /= 100),
                t.hsl2rgb(i, o, r, n))
              : ((l = {
                  r: i,
                ...
                (l.hex =
                  "#" +
                  (16777216 | r | (o << 8) | (i << 16)).toString(16).slice(1)),
                t.is(n, "finite") && (l.opacity = n),
                l))
          : {
              r: -1,
              g: -1,
      ...
      (t.parsePathString = i(function (e) {
        ...
        var i = {
          ...
          o = [];
        return (
          t.is(e, H) && t.is(e[0], H) && (o = ve(e)),
          o[M] ||
            S(e)[ee](se, function (t, e, r) {
              var n = [],
                s = E.call(e);
              for (
                r[ee](ae, function (t, e) {
                  e && n[$](+e);
                }),
                  "m" == s &&
                    n[M] > 2 &&
                    ...
                    (s = "l"),
                    (e = "m" == e ? "l" : "L"));
                n[M] >= i[s] && (o[$]([e][w](n.splice(0, i[s]))), i[s]);
      ...
      (t.findDotsAtSegment = function (t, e, i, o, r, n, s, a, l) {
        var c = 1 - l,
          h =
            P(c, 3) * t + 3 * P(c, 2) * l * i + 3 * c * l * l * r + P(l, 3) * s,
          u =
            P(c, 3) * e + 3 * P(c, 2) * l * o + 3 * c * l * l * n + P(l, 3) * a,
    ...
    var ge = i(function (t) {
        ...
        for (var e, i = 0, o = 0, r = [], n = [], s = 0, a = t[M]; a > s; s++)
          if (((e = t[s]), "M" == e[0]))
            ...
            (r = r[w](l.min.x, l.max.x)),
              (n = n[w](l.min.y, l.max.y)),
              (i = e[5]),
              (o = e[6]);
          }
        var c = B[y](0, r),
            ...
            if (u[0] != E.call(u[0]))
              switch (((h[0] = E.call(u[0])), h[0])) {
                ...
                case "m":
                  (n = u[1]), (s = u[2]);
                default:
                  for (var d = 1, p = u[M]; p > d; d++)
                    h[d] = +(u[d] - (d % 2 ? o : r)).toFixed(3);
              }
            else {
      ...
      we = i(
        function (e) {
          ...
          for (var l = a, c = e[M]; c > l; l++) {
            ...
            else for (var f = 0, m = u[M]; m > f; f++) i[l][f] = u[f];
            switch (h[0]) {
              case "Z":
                (o = n), (r = s);
                break;
      ...
      ke = function (t, e, o, r, n, s, a, l, c, h) {
        ...
        if (N(L) > d) {
          ...
          (E = C + d * (a && E > C ? 1 : -1)),
            (l = S + o * A.cos(E)),
            (c = z + r * A.sin(E)),
            (f = ke(l, c, o, r, n, 0, a, P, O, [E, B, S, z]));
        }
        L = E - C;
        var I = A.cos(C),
          H = A.sin(C),
          ...
          G = [l + $ * D, c - F * j],
          X = [l, c];
        if (((Y[0] = 2 * q[0] - Y[0]), (Y[1] = 2 * q[1] - Y[1]), h))
          return [Y, G, X][w](f);
        f = [Y, G, X][w](f)[_]()[T](",");
        for (var Q = [], U = 0, V = f[M]; V > U; U++)
          Q[U] = U % 2 ? m(f[U - 1], f[U], p).y : m(f[U], f[U + 1], p).x;
        return Q;
      },
      ...
      Te = i(function (t, e, i, o, r, n, s, a) {
        ...
        return (
          ...
          d > 0 &&
            1 > d &&
            ((l = Se(t, e, i, o, r, n, s, a, d)), m[$](l.x), f[$](l.y)),
          p > 0 &&
            1 > p &&
            ((l = Se(t, e, i, o, r, n, s, a, p)), m[$](l.x), f[$](l.y)),
          (c = n - 2 * o + e - (a - 2 * n + o)),
          (h = 2 * (o - e) - 2 * (n - o)),
          (u = e - o),
          (d = (-h + A.sqrt(h * h - 4 * c * u)) / 2 / c),
                ...
                switch (
                  ...
                  case "T":
                    (e.qx = e.x + (e.x - (e.qx || e.x))),
                      ...
                      (t = ["C"][w](be(e.x, e.y, e.qx, e.qy, t[1], t[2])));
                    break;
                  case "Q":
                    (e.qx = t[1]),
                      (e.qy = t[2]),
                      (t = ["C"][w](be(e.x, e.y, t[1], t[2], t[3], t[4])));
                    break;
                  case "L":
      ...
      _e = function (e, i, o, r) {
        ...
        return t.is(e, I) || t.is(e, "object")
          ? ((n = t.is(e, I) ? p.getElementById(e) : e),
            n.tagName
              ? null == i
                ? {
                    container: n,
    ...
    if (((t.pathToRelative = ye), t.svg)) {
      ...
      var Oe = function (t, e) {
        ...
        Ie = function (t, i, o) {
          var r = "linear",
            ...
            a = t.style;
          if (
            ((i = S(i)[ee](le, function (t, e, i) {
              if (((r = "radial"), e && i)) {
                (n = U(e)), (s = U(i));
                var o = 2 * (s > 0.5) - 1;
                P(n - 0.5, 2) + P(s - 0.5, 2) > 0.25 &&
                  (s = A.sqrt(0.25 - P(n - 0.5, 2)) * o + 0.5) &&
                  0.5 != s &&
          ...
          (d = d.match(/^url\(#(.*)\)$/)),
            d && o.defs.removeChild(p.getElementById(d[1]));
          var f = Re(r + "Gradient");
          (f.id = e()),
            Re(
              f,
        ...
        je = function (i, o) {
                    ...
                    s =
                      {
                        ...
                        square: i,
                        butt: 0,
                      }[t.attrs["stroke-linecap"] || o["stroke-linecap"]] || 0,
                    a = [],
                    l = e[M];
                  l--;
          ...
          var h = S(a)[T](l);
          h.length - 1 ? ((h[1] = +h[1]), (h[2] = +h[2])) : (h = null),
            U(a) && i.rotate(0, !0);
          for (var u in o)
            if (o[d](u)) {
              if (!J[d](u)) continue;
              ...
              switch (((s[u] = f), u)) {
                ...
                case "target":
                  ...
                  "target" == u && "blank" == f
                    ? m.setAttributeNS(i.paper.xlink, "show", "new")
                    : m.setAttributeNS(i.paper.xlink, u, f);
                  break;
                case "cursor":
                  n.style.cursor = f;
                  break;
                case "clip-rect":
                  ...
                  if (!f) {
                    var z = p.getElementById(
                      n.getAttribute("clip-path")[ee](/(^url\(#|\)$)/g, b)
                    );
                ...
                case "src":
                  "image" == i.type &&
                    n.setAttributeNS(i.paper.xlink, "href", f);
                  break;
                case "stroke-width":
                  (n.style.strokeWidth = f),
                    n[Q](u, f),
                    s["stroke-dasharray"] && c(i, s["stroke-dasharray"]);
                  break;
                ...
                case "scale":
                  (C = S(f)[T](l)),
                    i.scale(
                      +C[0] || 1,
                      +C[1] || +C[0] || 1,
                      isNaN(U(C[2])) ? null : +C[2],
                      isNaN(U(C[3])) ? null : +C[3]
                    );
                  break;
                case D:
                  var A = S(f).match(F);
                  if (A) {
                    ...
                    (w.id = e()),
                      ...
                      L.setAttributeNS(i.paper.xlink, "href", A[1]),
                      w[v](L);
                  ...
                  if (N.error) {
                    ...
                    delete o.gradient,
                      delete s.gradient,
                      !t.is(s.opacity, "undefined") &&
                        t.is(o.opacity, "undefined") &&
                        Re(n, {
                          opacity: s.opacity,
                        }),
                      !t.is(s["fill-opacity"], "undefined") &&
                  ...
                  N[d]("opacity") &&
                    Re(n, {
                      "fill-opacity":
                        N.opacity > 1 ? N.opacity / 100 : N.opacity,
                    });
                case "stroke":
                  (N = t.getRGB(f)),
                    n[Q](u, N.hex),
                ...
                case "fill-opacity":
                  if (s.gradient) {
                    var P = p.getElementById(
                      n.getAttribute(D)[ee](/^url\(#|\)$/g, b)
                    );
                    if (P) {
          ...
          if (
            ...
            var o = e.attrs,
              ...
              n = r.firstChild
                ? V(
                    p.defaultView
                      .getComputedStyle(r.firstChild, b)
              ...
              for (var s = S(i.text)[T]("\n"), a = 0, l = s[M]; l > a; a++)
                if (s[a]) {
                  ...
                  a &&
                    ...
                    c[v](p.createTextNode(s[a])),
                    r[v](c);
                }
            } else
              for (
                s = r.getElementsByTagName("tspan"), a = 0, l = s[M];
                l > a;
                a++
              )
                a &&
      ...
      ($e[u].rotate = function (e, i, o) {
        ...
        if (null == e)
          return this._.rt.cx
            ? [this._.rt.deg, this._.rt.cx, this._.rt.cy][_](k)
            : this._.rt.deg;
        var r = this.getBBox();
        return (
          (e = S(e)[T](l)),
          e[M] - 1 && ((i = U(e[1])), (o = U(e[2]))),
          (e = U(e[0])),
          null != i && i !== !1 ? (this._.rt.deg = e) : (this._.rt.deg += e),
          null == o && (i = null),
          (this._.rt.cx = i),
          (this._.rt.cy = o),
          (i = null == i ? r.x + r.width / 2 : i),
          (o = null == o ? r.y + r.height / 2 : o),
          this._.rt.deg
            ...
            for (var i = 0, o = this.node.getNumberOfChars(); o > i; i++) {
              ...
              r.y < e.y && (e.y = r.y),
                r.y + r.height - e.y > e.height &&
                  (e.height = r.y + r.height - e.y),
                r.x + r.width - e.x > e.width &&
                  (e.width = r.x + r.width - e.x);
            }
          }
        ...
        ($e[u].attr = function (e, i) {
          ...
          if (null == e) {
            ...
            for (var r in this.attrs)
              this.attrs[d](r) && (o[r] = this.attrs[r]);
            return (
              this._.rt.deg && (o.rotation = this.rotate()),
              (1 != this._.sx || 1 != this._.sy) && (o.scale = this.scale()),
              o.gradient &&
                "none" == o.fill &&
                (o.fill = o.gradient) &&
                delete o.gradient,
          ...
          if (null == i && t.is(e, I))
            return "translation" == e
              ...
              : "scale" == e
              ? this.scale()
              : e == D && "none" == this.attrs.fill && this.attrs.gradient
              ? this.attrs.gradient
              : this.attrs[e];
          if (null == i && t.is(e, H)) {
          ...
          for (var c in this.paper.customAttributes)
            if (
              this.paper.customAttributes[d](c) &&
              l[d](c) &&
              t.is(this.paper.customAttributes[c], "function")
            ) {
        ...
        ($e[u].insertAfter = function (t) {
          ...
          return (
            e.nextSibling
              ...
              : e.parentNode[v](this.node),
            Be(this, t, this.paper),
            this
          );
        }),
      ...
      var qe = function (t, e, i, o) {
        ...
        Xe = function (t, e, i, o, r, n) {
          ...
          Re(s, {
            ...
            s.setAttributeNS(t.xlink, "href", e),
            t.canvas && t.canvas[v](s);
          var a = new $e(s, t);
          return (
            (a.attrs = {
        ...
        Ue = function (t, e) {
          return (
            ...
            this.canvas[Q]("width", this.width),
            this.canvas[Q]("height", this.height),
            this
          );
        },
        Ve = function () {
          ...
          return (
            ...
            1 == i
              ? ((a.style.cssText =
                  "position:absolute;left:" + o + "px;top:" + r + "px"),
                p.body[v](a))
              : i.firstChild
      ...
      (a.clear = function () {
        ...
        (this.bottom = this.top = null),
          (this.desc = Re("desc"))[v](
            p.createTextNode("Created with RaphaÃ«l")
          ),
          t[v](this.desc),
          t[v]((this.defs = Re("defs")));
      }),
        (a.remove = function () {
    ...
    if (t.vml) {
      ...
      (t[j] = function () {
        ...
        (je = function (e, i) {
          ...
          if (
            (c &&
              ((s.path = o(s.x, s.y, s.width, s.height, s.r)),
              (e.X = s.x),
              (e.Y = s.y),
              (e.W = s.width),
              (e.H = s.height)),
            i.href && (n.href = i.href),
            i.title && (n.title = i.title),
            i.target && (n.target = i.target),
            i.cursor && (a.cursor = i.cursor),
            "blur" in i && e.blur(i.blur),
            ((i.path && "path" == e.type) || c) && (n.path = ni(s.path)),
            null != i.rotation && e.rotate(i.rotation, !0),
            i.translation &&
              ((r = S(i.translation)[T](l)),
              _i.call(e, r[0], r[1]),
              null != e._.rt.cx &&
                ((e._.rt.cx += +r[0]),
                (e._.rt.cy += +r[1]),
          ...
          if (
            ("image" == e.type && i.src && (n.src = i.src),
            "image" == e.type &&
              i.opacity &&
              ((n.filterOpacity =
                Z + ".Alpha(opacity=" + 100 * i.opacity + ")"),
              (a.filter = (n.filterMatrix || b) + (n.filterOpacity || b))),
            i.font && (a.font = i.font),
            i["font-family"] &&
              (a.fontFamily =
                '"' +
                i["font-family"][T](",")[0][ee](/^['"]+|['"]+$/g, b) +
                '"'),
            ...
            var w = n.getElementsByTagName(D) && n.getElementsByTagName(D)[0],
              x = !1;
            if (
              (!w && (x = w = si(D)), "fill-opacity" in i || "opacity" in i)
            ) {
              var k =
                ((+s["fill-opacity"] + 1 || 2) - 1) *
                ((+s.opacity + 1 || 2) - 1) *
                ...
                : ((w.color = t.getRGB(i.fill).hex),
                  ...
                  t.getRGB(i.fill).error &&
                    (h.type in
                      ...
                      "r" != S(i.fill).charAt()) &&
                    Ie(h, i.fill) &&
                    ((s.fill = "none"), (s.gradient = i.fill)));
            }
            x && n[v](w);
            var C =
                n.getElementsByTagName("stroke") &&
            ...
            C.on && i.stroke && (C.color = E.hex),
              (k =
                ((+s["stroke-opacity"] + 1 || 2) - 1) *
                ((+s.opacity + 1 || 2) - 1) *
                ((+E.o + 1 || 2) - 1));
            var A = 0.75 * (U(i["stroke-width"]) || 1);
            if (
              ((k = B(L(k, 0), 1)),
              null == i["stroke-width"] && (A = s["stroke-width"]),
              i["stroke-width"] && (C.weight = A),
              A && 1 > A && (k *= A) && (C.weight = 1),
              (C.opacity = k),
              i["stroke-linejoin"] &&
                (C.joinstyle = i["stroke-linejoin"] || "miter"),
              (C.miterlimit = i["stroke-miterlimit"] || 8),
              i["stroke-linecap"] &&
                (C.endcap =
              ...
              C.dashstyle = N[d](i["stroke-dasharray"])
                ? N[i["stroke-dasharray"]]
                : b;
            }
            _ && n[v](C);
          }
          if ("text" == h.type)
            switch (
              ((a = h.paper.span.style),
              s.font && (a.font = s.font),
              s["font-family"] && (a.fontFamily = s["font-family"]),
              s["font-size"] && (a.fontSize = s["font-size"]),
              s["font-weight"] && (a.fontWeight = s["font-weight"]),
              s["font-style"] && (a.fontStyle = s["font-style"]),
              h.node.string &&
                (h.paper.span.innerHTML = S(h.node.string)
                  [ee](/</g, "&#60;")
                  [ee](/&/g, "&#38;")
                  [ee](/\n/g, "<br>")),
              (h.W = s.w = h.paper.span.offsetWidth),
              (h.H = s.h = h.paper.span.offsetHeight),
              (h.X = s.x),
              (h.Y = s.y + X(h.H / 2)),
              s["text-anchor"])
            ) {
        ...
        (Ie = function (t, e) {
            ...
            (e = S(e)[ee](le, function (t, e, i) {
              return (
                ...
                e &&
                  ...
                  ((e = U(e)),
                  (i = U(i)),
                  P(e - 0.5, 2) + P(i - 0.5, 2) > 0.25 &&
                    (i =
                      A.sqrt(0.25 - P(e - 0.5, 2)) * (2 * (i > 0.5) - 1) + 0.5),
                  (r = e + k + i)),
                b
              );
            })),
          ...
          if (
            ((t = t.shape || t.node),
            (i = t.getElementsByTagName(D)[0] || si(D)),
            ...
            (i.on = !0),
              (i.method = "none"),
              (i.color = s[0].color),
              (i.color2 = s[s[M] - 1].color);
            for (var a = [], l = 0, c = s[M]; c > l; l++)
              s[l].offset && a[$](s[l].offset + k + s[l].color);
            i.colors && (i.colors.value = a[M] ? a[_]() : "0% " + i.color),
              "radial" == o
                ? ((i.type = "gradientradial"),
                  (i.focus = "100%"),
                  (i.focussize = r),
                  (i.focusposition = r))
                : ((i.type = "gradient"), (i.angle = (270 - n) % 360));
          }
          return 1;
        }),
        ($e = function (e, i, o) {
          (this[0] = e),
            ...
            !o.bottom && (o.bottom = this),
            (this.prev = o.top),
            o.top && (o.top.next = this),
            (o.top = this),
            (this.next = null);
        }),
        (Fe = $e[u]),
        (Fe.rotate = function (t, e, i) {
          return this.removed
            ? this
            : null == t
            ? this._.rt.cx
        ...
        (Fe.setBox = function (t, e, i) {
          ...
          var p,
            f = e - this.paper.width / 2,
            m = i - this.paper.height / 2;
          o.left != (p = f + "px") && (o.left = p),
            o.top != (p = m + "px") && (o.top = p),
            (this.X = ri[d](this.type) ? -f : s),
            (this.Y = ri[d](this.type) ? -m : a),
            (this.W = l),
            (this.H = c),
            ri[d](this.type)
              ? (r.left != (p = -f * oi + "px") && (r.left = p),
                r.top != (p = -m * oi + "px") && (r.top = p))
              : "text" == this.type
              ? (r.left != (p = -f + "px") && (r.left = p),
                r.top != (p = -m + "px") && (r.top = p))
              : (o.width != (p = this.paper.width + "px") && (o.width = p),
                o.height != (p = this.paper.height + "px") && (o.height = p),
                r.left != (p = s - f + "px") && (r.left = p),
                r.top != (p = a - m + "px") && (r.top = p),
                r.width != (p = l + "px") && (r.width = p),
                r.height != (p = c + "px") && (r.height = p));
        }),
        (Fe.hide = function () {
        ...
        (Fe.attr = function (e, i) {
          ...
          if (
            ...
            for (var l in this.paper.customAttributes)
              if (
                this.paper.customAttributes[d](l) &&
                a[d](l) &&
                t.is(this.paper.customAttributes[l], "function")
              ) {
            ...
            a.text && "text" == this.type && (this.node.string = a.text),
              ...
              a.gradient &&
                ({
                  ...
                  "r" != S(a.gradient).charAt()) &&
                Ie(this, a.gradient),
              (!ri[d](this.type) || this._.rt.deg) && this.setBox(this.attrs);
          }
          return this;
        }),
        (Fe.toFront = function () {
          return (
            !this.removed && this.Group.parentNode[v](this.Group),
            this.paper.top != this && Ae(this, this.paper),
            this
          );
        }),
        (Fe.toBack = function () {
        ...
        (Fe.insertAfter = function (t) {
          return this.removed
            ? this
            : (t.constructor == Mi && (t = t[t.length - 1]),
              t.Group.nextSibling
                ? t.Group.parentNode.insertBefore(
                    this.Group,
                    t.Group.nextSibling
                  )
                : t.Group.parentNode[v](this.Group),
              Be(this, t, this.paper),
              this);
        }),
        ...
        (Fe.blur = function (e) {
          ...
          (o = o.replace(Je, b)),
            0 !== +e
              ? ((this.attrs.blur = e),
                (i.filter =
                  o + k + Z + ".Blur(pixelradius=" + (+e || 1.5) + ")"),
                (i.margin = t.format("-{0}px 0 0 -{0}px", X(+e || 1.5))))
              : ((i.filter = o), (i.margin = 0), delete this.attrs.blur);
        }),
        (qe = function (t, e, i, o) {
          {
            var r = si("group"),
      ...
      try {
        !p.namespaces.rvml &&
          p.namespaces.add("rvml", "urn:schemas-microsoft-com:vml"),
          (si = function (t) {
      ...
      (Ve = function () {
        ...
        return (
          ...
          (a.width = 1e3),
          (a.height = 1e3),
          (a.coordsize = 1e3 * oi + k + 1e3 * oi),
          (a.coordorigin = "0 0"),
          (a.span = p.createElement("span")),
    ...
    a.safari =
      ...
      ((ai && ai[1] < 4) || "iP" == navigator.platform.slice(0, 2))
        ? function () {
          ...
          return p.addEventListener
                ...
                var r = x && C[e] ? C[e] : e,
                  n = function (r) {
                    if (x && C[d](e))
                      for (
                        var n = 0,
                          s = r.targetTouches && r.targetTouches.length;
                        s > n;
                        n++
                      )
            ...
            ? function (t, e, i, o) {
                var r = function (t) {
                  return (
                    (t = t || f.event),
                    (t.preventDefault = t.preventDefault || li),
                    (t.stopPropagation = t.stopPropagation || hi),
                    i.call(o, t)
                  );
                };
        ...
        pi = [],
          ...
          for (
            var e,
              i = t.clientX,
              o = t.clientY,
              r = p.documentElement.scrollTop || p.body.scrollTop,
              n = p.documentElement.scrollLeft || p.body.scrollLeft,
              s = pi.length;
            s--;
    ...
    (Fe.hover = function (t, e, i, o) {
        ...
        return (
          ...
          this.mousedown(function (a) {
            ...
            (this._drag.x = a.clientX + c),
              ...
              i && i.call(n || r || this, a.clientX + c, a.clientY + l, a),
              !pi.length && t.mousemove(fi).mouseup(mi),
              pi.push({
                el: this,
                move: e,
                end: o,
      ...
      (a.path = function (e) {
        return (
          e && !t.is(e, I) && !t.is(e[0], H) && (e += b),
          Oe(t.format[y](t, arguments), this)
        );
      }),
      ...
      (a.set = function (t) {
        return (
          arguments[M] > 1 &&
            (t = Array[u].splice.call(arguments, 0, arguments[M])),
          new Mi(t)
        );
      }),
      (a.setSize = Ue),
      (a.top = a.bottom = null),
      (a.raphael = t),
      (Fe.resetScale = function () {
        return this.removed
          ? this
          : ((this._.sx = 1), (this._.sy = 1), void (this.attrs.scale = "1 1"));
      }),
      (Fe.scale = function (t, e, i, o) {
        ...
        if (0 != t) {
            ...
            case "path":
              for (
                ...
                if ("M" != H || !L)
                  ...
                  else for (j = 1, D = I[M]; D > j; j++) I[j] *= j % 2 ? B : P;
              }
              var W = ge(A);
              (n = S - W.x - W.width / 2),
                (s = T - W.y - W.height / 2),
          ...
          (1 != m || 1 != g)
            ? this.transformations
              ? ((this.transformations[2] = "scale("[w](m, ",", g, ")")),
                this.node[Q]("transform", this.transformations[_](k)),
                (n = -1 == m ? -a.x - (C || 0) : a.x),
                (s = -1 == g ? -a.y - (E || 0) : a.y),
                this.attr({
                  x: n,
              ...
              : ((this.node.filterMatrix =
                ...
                (x.filter =
                  (this.node.filterMatrix || b) +
                  (this.node.filterOpacity || b)))
            : this.transformations
            ? ((this.transformations[2] = b),
              this.node[Q]("transform", this.transformations[_](k)),
              (a.fx = 0),
              (a.fy = 0))
            : ((this.node.filterMatrix = b),
      ...
      (Fe.clone = function () {
        ...
        var t = this.attr();
        return (
          delete t.scale, delete t.translation, this.paper[this.type]().attr(t)
        );
      });
    var vi = {},
      yi = function (e, i, o, r, n, s, a, l, c) {
        ...
        for (var v = 0; p + 1 > v; v++) {
          if (
            (m.data[c] > v
              ? (u = m.data[v * p])
              : ((u = t.findDotsAtSegment(e, i, o, r, n, s, a, l, v / p)),
                (m.data[v] = u)),
            v && (d += P(P(h.x - u.x, 2) + P(h.y - u.y, 2), 0.5)),
            null != c && d >= c)
          )
            return u;
          h = u;
      ...
      wi = function (e, i) {
        return function (o, r, n) {
          o = ze(o);
          for (
            var s, a, l, c, h, u = "", d = {}, p = 0, f = 0, m = o.length;
            m > f;
            f++
          ) {
            if (((l = o[f]), "M" == l[0])) (s = +l[1]), (a = +l[2]);
              ...
              if (
                ((c = yi(s, a, l[1], l[2], l[3], l[4], l[5], l[6])), p + c > r)
              ) {
                if (i && !d.start) {
                  if (
                    ((h = yi(s, a, l[1], l[2], l[3], l[4], l[5], l[6], r - p)),
    ...
    (Fe.getTotalLength = function () {
      ...
      (Fe.getSubpath = function (t, e) {
        if ("path" == this.type) {
          if (N(this.getTotalLength() - e) < "1e-6")
            return ki(this.attrs.path, t).end;
      ...
      (t.easing_formulas = {
        ...
        "<>": function (t) {
          return (
            (t = 2 * t), 1 > t ? P(t, 3) / 2 : ((t -= 2), (P(t, 3) + 2) / 2)
          );
        },
        backIn: function (t) {
          var e = 1.70158;
        ...
        bounce: function (t) {
          ...
          return (
            1 / o > t
              ? (e = i * t * t)
              : 2 / o > t
              ? ((t -= 1.5 / o), (e = i * t * t + 0.75))
              : 2.5 / o > t
              ? ((t -= 2.25 / o), (e = i * t * t + 0.9375))
              : ((t -= 2.625 / o), (e = i * t * t + 0.984375)),
            e
          );
        },
      });
        ...
        for (var e = +new Date(), i = 0; i < Si[M]; i++) {
          ...
          if (!o.stop && !o.el.removed) {
            ...
            if (s > n) {
                ...
                if (l[d](g)) {
                  switch (te[g]) {
                    case "along":
                      ...
                      var v = bi(h[g], r);
                      p.translate(c.sx - c.x || 0, c.sy - c.y || 0),
                        (c.x = v.x),
                        (c.y = v.y),
                        p.translate(v.x - c.sx, v.y - c.sy),
                        h.rot && p.rotate(c.r + v.alpha, v.x, v.y);
                      break;
                    case O:
                      r = +l[g] + m * s * c[g];
                      break;
                    case "colour":
                      r =
                        "rgb(" +
                        [
                          Ci(X(l[g].r + m * s * c[g].r)),
                          Ci(X(l[g].g + m * s * c[g].g)),
                          Ci(X(l[g].b + m * s * c[g].b)),
                        ][_](",") +
                        ")";
                      break;
                    case "path":
                      ...
                      for (var y = 0, w = l[g][M]; w > y; y++) {
                        r[y] = [l[g][y][0]];
                        for (var x = 1, S = l[g][y][M]; S > x; x++)
                          r[y][x] = +l[g][y][x] + m * s * c[g][y][x];
                        r[y] = r[y][_](k);
                      }
                      r = r[_](k);
                      break;
                    ...
                    default:
                      var C = [].concat(l[g]);
                      for (
                        r = [], y = p.paper.customAttributes[g].length;
                        y--;
              ...
              h.along &&
                ((v = bi(h.along, h.len * !h.back)),
                p.translate(
                  c.sx - (c.x || 0) + v.x - c.sx,
                  c.sy - (c.y || 0) + v.y - c.sy
                ),
                h.rot && p.rotate(c.r + v.alpha, v.x, v.y)),
                (u.x || u.y) && p.translate(-u.x, -u.y),
                h.scale && (h.scale += b),
                p.attr(h),
                Si.splice(i--, 1);
          }
    ...
    (Fe.animateWith = function (t, e, i, o, r) {
      for (var n = 0, s = Si.length; s > n; n++)
        Si[n].el.id == t.id && (e.start = Si[n].start);
      return this.animate(e, i, o, r);
    }),
      (Fe.animateAlong = n()),
      (Fe.animateAlongBack = n(1)),
      (Fe.onAnimation = function (t) {
      ...
      (Fe.animate = function (e, i, o, r) {
        ...
        var a = {},
          ...
          u = {};
        for (var p in e)
          if (e[d](p) && (te[d](p) || n.paper.customAttributes[d](p)))
            switch (
              ((h = !0),
              (a[p] = n.attr(p)),
              null == a[p] && (a[p] = J[p]),
              ...
              case "path":
                ...
                for (var x = 0, b = a[p][M]; b > x; x++) {
                  u[p][x] = [0];
                  for (var k = 1, z = a[p][x][M]; z > k; k++)
                    u[p][x][k] = (w[x][k] - a[p][x][k]) / i;
                }
                break;
              case "csv":
                var C = S(e[p])[T](l),
                ...
                switch (p) {
                  case "translation":
                    ...
                    break;
                  case "rotation":
                    (a[p] = _[1] == C[1] && _[2] == C[2] ? _ : [0, C[1], C[2]]),
                      (u[p] = [(C[0] - a[p][0]) / i, 0, 0]);
                    break;
                  case "scale":
                    (e[p] = C),
              ...
              default:
                for (
                  C = [].concat(e[p]),
                    _ = [].concat(a[p]),
                    u[p] = [],
                    x = n.paper.customAttributes[p][M];
                  x--;
        ...
        if (h) {
          ...
          Si.push({
            ...
            t.is(r, "function") &&
              (n._ac = setTimeout(function () {
                r.call(n);
              }, i)),
            1 == Si[M] && setTimeout(Ti);
        } else {
          var L,
            B = [];
          for (var N in e)
          ...
          for (
            ...
            zi(
              ...
              n,
              (i / 100) * B[x].key,
              (i / 100) * ((B[x - 1] && B[x - 1].key) || 0),
              B[x - 1] && B[x - 1].value.callback
            );
          (L = B[B[M] - 1].value.callback),
            L &&
              n.timeouts.push(
                setTimeout(function () {
                  L.call(n);
      ...
      (Fe.stop = function () {
        for (var t = 0; t < Si.length; t++)
          Si[t].el.id == this.id && Si.splice(t--, 1);
        for (t = 0, ii = this.timeouts && this.timeouts.length; ii > t; t++)
          clearTimeout(this.timeouts[t]);
        return (
          (this.timeouts = []), clearTimeout(this._ac), delete this._ac, this
        );
      }),
    ...
    var Mi = function (t) {
      if (((this.items = []), (this[M] = 0), (this.type = "set"), t))
        for (var e = 0, i = t[M]; i > e; e++)
          !t[e] ||
            (t[e].constructor != $e && t[e].constructor != Mi) ||
            ((this[this.items[M]] = this.items[this.items[M]] = t[e]),
            this[M]++);
    };
    (Mi[u][$] = function () {
      for (var t, e, i = 0, o = arguments[M]; o > i; i++)
        (t = arguments[i]),
          !t ||
            (t.constructor != $e && t.constructor != Mi) ||
            ((e = this.items[M]), (this[e] = this.items[e] = t), this[M]++);
      return this;
    }),
      (Mi[u].pop = function () {
    ...
    for (var Ei in Fe)
      Fe[d](Ei) &&
        (Mi[u][Ei] = (function (t) {
          return function () {
            for (var e = 0, i = this.items[M]; i > e; e++)
              this.items[e][t][y](this.items[e], arguments);
            return this;
          };
        })(Ei));
    (Mi[u].attr = function (e, i) {
      ...
      (Mi[u].animate = function (e, i, o, r) {
        ...
        for (
          r &&
            ...
            o = t.is(o, I) ? o : s,
            n = this.items[--l].animate(e, i, o, s);
          l--;

        )
          this.items[l] &&
            !this.items[l].removed &&
            this.items[l].animateWith(n, e, i, o, s);
        return this;
      }),
      ...
      (t.registerFont = function (t) {
        ...
        if (
          (this.fonts[i] ? this.fonts[i][$](e) : (this.fonts[i] = [e]), !t.svg)
        ) {
        ...
        if (
          ...
          if (n)
            for (
              ...
              h > c &&
              ((l = n[c]),
              l.face["font-weight"] != i ||
                (l.face["font-style"] != o && l.face["font-style"]) ||
                l.face["font-stretch"] != r);
              c++
            );
          return l;
        }
      ...
      (a.print = function (e, i, o, r, n, s, a) {
        ...
        if ((t.is(r, o) && (r = this.getFont(r)), r)) {
          ...
          for (
            var p = r.face.bbox.split(l),
              f = +p[0],
              m =
                +p[1] +
                ("baseline" == s
                  ? p[3] - p[1] + +r.face.descent
                  : (p[3] - p[1]) / 2),
              g = 0,
              v = u[M];
            v > g;
            ...
            var y = (g && r.glyphs[u[g - 1]]) || {},
              w = r.glyphs[u[g]];
            (d += g ? (y.w || r.w) + ((y.k && y.k[u[g]]) || 0) + r.w * a : 0),
              w &&
                w.d &&
                h[$](
                  this.path(w.d).attr({
  ...
  (function (t, e, i) {
    ...
    t.fn.imagesLoaded = function (e) {
      function r() {
        var i = t(d),
          o = t(p);
        l && (p.length ? l.reject(h, i, o) : l.resolve(h)),
          t.isFunction(e) && e.call(a, h, i, o);
      }
      ...
      function s(e, i) {
        e.src !== o &&
          ...
          c && l.notifyWith(t(e), [i, h, t(d), t(p)]),
          h.length === u.length &&
            (setTimeout(r), h.unbind(".imagesLoaded", n)));
      }
      var a = this,
      ...
      return (
        ...
        h.length
          ? h
              .bind("load.imagesLoaded error.imagesLoaded", n)
              .each(function (e, r) {
                var n = r.src,
                  a = t.data(r, "imagesLoaded");
                return a && a.src === n
                  ? void s(r, a.isBroken)
                  : r.complete && r.naturalWidth !== i
                  ? void s(r, 0 === r.naturalWidth || 0 === r.naturalHeight)
                  : void (
                      (r.readyState || r.complete) &&
                      ((r.src = o), (r.src = n))
                    );
              })
          : r(),
    ...
    (t.Flipshow = function (e, i) {
      ...
      (t.Flipshow.prototype = {
        _init: function (e) {
          (this.options = t.extend(!0, {}, t.Flipshow.defaults, e)),
            (this.support = r.csstransitions && r.csstransforms3d);
          var i = {
          ...
          this.support &&
            ((this.transEndEventName =
              i[r.prefixed("transition")] + ".cbpFWSlider"),
            (this.transformName = o[r.prefixed("transform")])),
        ...
        _addNav: function () {
          var e = this,
            ...
            o = t(
              '<div class="fc-right"><span></span><span></span><span></span><i class="icon-arrow-right"></i></div>'
            );
          t("<nav></nav>").append(i, o).appendTo(this.$el),
            i
              .find("span")
        ...
        _layout: function () {
          (this.$flipFront = t('<div class="fc-front"><div></div></div>')),
            (this.$frontContent = this.$flipFront.children("div:first")),
            (this.$flipBack = t('<div class="fc-back"><div></div></div>')),
            (this.$backContent = this.$flipBack.children("div:first")),
            (this.$flipEl = t('<div class="fc-flip"></div>')
        ...
        _flip: function (e, i, o, r) {
          ...
          this.$flipEl.css("transition", this.transitionProperties),
            ...
            this.$flipBack
              ...
              .remove(),
            "right" === o
              ? (this.$flipFront.append(s),
                this.$flipBack.append(a),
                a.css("opacity", 1))
              : "left" === o &&
                (this.$flipFront.append(a),
                this.$flipBack.append(s),
                s.css("opacity", 1));
          var l = {
          ...
          this.$flipBack.css("transform", n),
            this.$frontContent.empty().html(e.html()),
            this.$backContent.empty().html(i.html()),
            this.$flipEl.show();
          var c = this;
          setTimeout(function () {
            c.$flipEl.css("transform", n),
              s.css("opacity", "right" === o ? 1 : 0),
              a.css("opacity", "right" === o ? 0 : 1),
              c.$flipEl.on(c.transEndEventName, function (t) {
                "fc-overlay-light" !== t.target.className &&
                  "fc-overlay-dark" !== t.target.className &&
                  c._ontransitionend(i);
              });
          }, 25);
        },
    ...
    t.fn.flipshow = function (e) {
      if ("string" == typeof e) {
        ...
        this.each(function () {
          ...
          return o
            ? t.isFunction(o[e]) && "_" !== e.charAt(0)
              ? void o[e].apply(o, i)
              : void n("no such method '" + e + "' for flipshow instance")
            : void n(
        ...
        this.each(function () {
          ...
          i
            ? i._init()
            : (i = t.data(this, "flipshow", new t.Flipshow(e, this)));
        });
      return this;
    };
  })(jQuery, window),
  (function (t, e) {
        ...
        csstransforms3d: function () {
          ...
          if (t) {
            var i = " -o- -moz- -ms- -webkit- -khtml- ".split(" "),
              ...
              r = e(
                "<style>" + o + "{#modernizr{height:3px}}</style>"
              ).appendTo("head"),
    ...
    if (r) for (i in h) r.hasOwnProperty(i) || r.addTest(i, h[i]);
    else {
      r = t.Modernizr = {
      ...
      (e.Isotope.prototype = {
        _create: function (t) {
          ...
          for (var n = 0, s = o.length; s > n; n++)
            (r = o[n]), (this.originalStyle[r] = i[r] || "");
          ...
          setTimeout(function () {
            ...
            this.options.resizable &&
              b.bind("smartresize.isotope", function () {
                l.resize();
              }),
        ...
        _updateAnimationEngine: function () {
          var t,
            e = this.options.animationEngine
              .toLowerCase()
              .replace(/[ _\-]/g, "");
          switch (e) {
            case "css":
          ...
          var t = this.options.sortBy,
            ...
            o = function (o, r) {
              ...
              return (
                n === s &&
                  "original-order" !== t &&
                  ((n = e(o, "original-order")), (s = e(r, "original-order"))),
                (n > s ? 1 : s > n ? -1 : 0) * i
              );
            };
        ...
        _processStyleQueue: function (t, i) {
          ...
          if (
            ...
            n = function (t, e) {
              (o = e.$el.hasClass("no-transition") ? "css" : l),
                e.$el[o](e.style, c);
            };
            ...
            if (
              ...
              for (
                var f, v = 0, y = this.styleQueue[0], w = y && y.$el;
                !w || !w.length;
        ...
        insert: function (t, e) {
          ...
          this.addItems(t, function (t) {
            var o = i._filter(t);
            i._addHideAppended(o),
              i._sort(),
              i.reLayout(),
              i._revealAppended(o, e);
          });
        },
        ...
        _getSegments: function (t) {
          var e,
            ...
            a = this.element[r](),
            l =
              (this.options[i] && this.options[i][o]) ||
              this.$filteredAtoms["outer" + n(r)](!0) ||
              a;
          (e = Math.floor(a / l)),
            (e = Math.max(e, 1)),
            (this[i][s] = e),
        ...
        _masonryLayout: function (t) {
          ...
          t.each(function () {
            ...
            if (((r = Math.min(r, o.cols)), 1 === r))
              i._masonryPlaceBrick(t, o.colYs);
            else {
              var n,
                s,
                a = o.cols + 1 - r,
                l = [];
              for (s = 0; a > s; s++)
                (n = o.colYs.slice(s, s + r)), (l[s] = Math.max.apply(Math, n));
        ...
        _masonryPlaceBrick: function (t, e) {
          for (
            var i = Math.min.apply(Math, e), o = 0, r = 0, n = e.length;
            n > r;
            r++
          )
            if (e[r] === i) {
        ...
        _fitRowsLayout: function (t) {
          ...
          t.each(function () {
            var t = e(this),
              n = t.outerWidth(!0),
              s = t.outerHeight(!0);
            0 !== r.x && n + r.x > o && ((r.x = 0), (r.y = r.height)),
              i._pushPosition(t, r.x, r.y),
              (r.height = Math.max(r.y + s, r.height)),
              (r.x += n);
          });
        },
        ...
        _cellsByRowLayout: function (t) {
          ...
          t.each(function () {
            var t = e(this),
              ...
              s = (r + 0.5) * o.columnWidth - t.outerWidth(!0) / 2,
              a = (n + 0.5) * o.rowHeight - t.outerHeight(!0) / 2;
        ...
        _masonryHorizontalLayout: function (t) {
          ...
          t.each(function () {
            ...
            if (((r = Math.min(r, o.rows)), 1 === r))
              i._masonryHorizontalPlaceBrick(t, o.rowXs);
            else {
              var n,
                s,
                a = o.rows + 1 - r,
                l = [];
              for (s = 0; a > s; s++)
                (n = o.rowXs.slice(s, s + r)), (l[s] = Math.max.apply(Math, n));
        ...
        _fitColumnsLayout: function (t) {
          ...
          t.each(function () {
            var t = e(this),
              n = t.outerWidth(!0),
              s = t.outerHeight(!0);
            0 !== r.y && s + r.y > o && ((r.x = r.width), (r.y = 0)),
              i._pushPosition(t, r.x, r.y),
              (r.width = Math.max(r.x + n, r.width)),
              (r.y += s);
          });
        },
      ...
      (e.fn.imagesLoaded = function (t) {
        ...
        function o(t) {
          ...
          r.src !== a &&
            -1 === e.inArray(r, l) &&
            (l.push(r),
            --s <= 0 && (setTimeout(i), n.unbind(".imagesLoaded", o)));
        }
        var r = this,
        ...
        return (
          s || i(),
          n.bind("load.imagesLoaded error.imagesLoaded", o).each(function () {
            var t = this.src;
    ...
    e.fn.isotope = function (t, i) {
      if ("string" == typeof t) {
        ...
        this.each(function () {
          ...
          return i
            ? e.isFunction(i[t]) && "_" !== t.charAt(0)
              ? void i[t].apply(i, o)
              : void k("no such method '" + t + "' for isotope instance")
            : void k(
        ...
        this.each(function () {
          ...
          o
            ? (o.option(t), o._init(i))
            : e.data(this, "isotope", new e.Isotope(t, this, i));
        });
      return this;
    };
  })(window, jQuery),
  !(function (t, e, i) {
    (t.fn.scrollUp = function (e) {
      ...
      (t.fn.scrollUp.init = function (o) {
        var r,
          n = (t.fn.scrollUp.settings = t.extend(
            {},
        ...
        (r = n.scrollTrigger
          ...
          n.scrollTitle && r.attr("title", n.scrollTitle),
          r.appendTo("body"),
          n.scrollImg || n.scrollTrigger || r.html(n.scrollText),
          r.css({
            display: "none",
            position: "fixed",
            zIndex: n.zIndex,
        ...
        var u;
        n.scrollTarget
          ? "number" == typeof n.scrollTarget
            ? (u = n.scrollTarget)
            : "string" == typeof n.scrollTarget &&
              (u = Math.floor(t(n.scrollTarget).offset().top))
          : (u = 0),
          r.click(function (e) {
            e.preventDefault(),
              t("html, body").animate(
    ...
    i.extend(a, {
              ...
              "object" === i.type(n) &&
                ...
                u(n)
                  ? ((g = {
                    ...
                    i.metadata && i.extend(!0, g, n.metadata()))
                  : (g = n)),
                (s = e.href || g.href || (d(n) ? n : null)),
                (l = e.title !== o ? e.title : g.title || ""),
                (c = e.content || g.content),
                (h = c ? "html" : e.type || g.type),
                !h &&
                  g.isDom &&
                  ((h = n.data("fancybox-type")),
                  h ||
                    ((p = n.prop("class").match(/fancybox\.(\w+)/)),
                    (h = p ? p[1] : null))),
                d(s) &&
                  (h ||
                    (a.isImage(s)
                ...
                c ||
                  ("inline" === h
                    ? s
                      ? (c = i(d(s) ? s.replace(/.*(?=#[^\s]+$)/, "") : s))
                      : g.isDom && (c = n)
                    : "html" === h
                    ? (c = s)
                    : h || s || !g.isDom || ((h = "inline"), (c = n))),
                i.extend(g, {
                  href: s,
                  type: h,
                  content: c,
      ...
      jumpto: function (t, e, i) {
        ...
        r &&
          ...
          (a.router = i || "jumpto"),
          r.loop &&
            (0 > t && (t = r.group.length + (t % r.group.length)),
            (t %= r.group.length)),
          r.group[t] !== o && (a.cancel(), a._start(t)));
      },
      reposition: function (t, e) {
        ...
        n &&
          ((o = a._getPosition(e)),
          t && "scroll" === t.type
            ? (delete o.position, n.stop(!0, !0).animate(o, 200))
            : (n.css(o), (r.pos = i.extend({}, r.dim, o))));
      },
      update: function (t) {
        var e = t && t.type,
            ...
            (c = setTimeout(
              function () {
                ...
                o &&
                  ...
                  (i || "load" === e || ("resize" === e && o.autoResize)) &&
                    a._setDimension(),
      ...
      getViewport: function () {
        ...
        return (
          e
            ...
            : ((i.w = h && t.innerWidth ? t.innerWidth : n.width()),
              (i.h = h && t.innerHeight ? t.innerHeight : n.height())),
          i
        );
      },
      ...
      bindEvents: function () {
        ...
        e &&
              ...
              return 27 === n && a.coming
                ...
                : void (
                    ...
                    i.each(t, function (t, s) {
                      return e.group.length > 1 && s[n] !== o
                        ? (a[t](s[n]), r.preventDefault(), !1)
                        : i.inArray(n, s) > -1
          ...
          i.fn.mousewheel &&
            e.mouseWheel &&
            a.wrap.bind("mousewheel.fb", function (t, o, r, n) {
              for (
                var s = t.target || null, l = i(s), c = !1;
                l.length &&
              ...
              0 === o ||
                ...
                (a.group.length > 1 &&
                  !e.canShrink &&
                  (n > 0 || r > 0
                    ? a.prev(n > 0 ? "down" : "left")
                    : (0 > n || 0 > r) && a.next(0 > n ? "up" : "right"),
                  t.preventDefault()));
            }));
      },
      trigger: function (t, e) {
        ...
        if (r) {
          if (
            (i.isFunction(r[t]) &&
              (o = r[t].apply(r, Array.prototype.slice.call(arguments, 1))),
            o === !1)
          )
            return !1;
          r.helpers &&
            i.each(r.helpers, function (e, o) {
              o &&
                a.helpers[e] &&
                i.isFunction(a.helpers[e][t]) &&
                a.helpers[e][t](i.extend(!0, {}, a.helpers[e].defaults, o), r);
            }),
            s.trigger(t);
        }
      },
      ...
      _start: function (t) {
        ...
        if (
          ...
          (n = l.margin),
          (s = l.padding),
          "number" === i.type(n) && (l.margin = [n, n, n, n]),
          "number" === i.type(s) && (l.padding = [s, s, s, s]),
          l.modal &&
            i.extend(!0, l, {
              closeBtn: !1,
              closeClick: !1,
                ...
                : u(e) &&
                  ...
                  t.wrap.bind("onReset", function () {
                    i(this).find(e).length &&
                      e.hide().replaceAll(e.data(h)).data(h, !1);
                  }));
              break;
            case "image":
      ...
      _setDimension: function () {
        ...
        if (
          (T.add(z)
            ...
            .height("auto")
            .removeClass("fancybox-tmp"),
          (t = m(z.outerWidth(!0) - z.width())),
          (e = m(z.outerHeight(!0) - z.height())),
          (o = I + t),
          (r = H + e),
          (n = p(M) ? ((x.w - o) * m(M)) / 100 : M),
          (s = p(E) ? ((x.h - r) * m(E)) / 100 : E),
          "iframe" === _.type)
        ) {
          if (((y = _.content), _.autoHeight && 1 === y.data("ready")))
            try {
              y[0].contentWindow.document.location &&
                (C.width(n).height(9999),
                (w = y.contents().find("body")),
                R && w.css("overflow-x", "hidden"),
                (s = w.outerHeight(!0)));
            } catch (j) {}
        } else
          (_.autoWidth || _.autoHeight) &&
            (C.addClass("fancybox-tmp"),
            _.autoWidth || C.width(n),
            _.autoHeight || C.height(s),
            _.autoWidth && (n = C.width()),
            _.autoHeight && (s = C.height()),
        ...
        if (
          ...
          (c = N),
          _.fitToView &&
            ((B = Math.min(x.w - o, B)), (N = Math.min(x.h - r, N))),
          (f = x.w - I),
          (v = x.h - H),
          _.aspectRatio
            ? (M > B && ((M = B), (E = m(M / h))),
              ...
              A > M && ((M = A), (E = m(M / h))),
              L > E && ((E = L), (M = m(E * h))))
            : ((M = Math.max(A, Math.min(M, B))),
              _.autoHeight &&
                "iframe" !== _.type &&
                (C.width(M), (E = C.height())),
              (E = Math.max(L, Math.min(E, N)))),
          _.fitToView)
        )
          if (
            (C.width(M).height(E),
            ...
            for (; (u > f || d > v) && M > A && E > L && !(b++ > 19); )
              (E = Math.max(L, Math.min(N, E - 10))),
                (M = m(E * h)),
                A > M && ((M = A), (E = m(M / h))),
                M > B && ((M = B), (E = m(M / h))),
                C.width(M).height(E),
            ...
            (M = Math.max(A, Math.min(M, M - (u - f)))),
              (E = Math.max(L, Math.min(E, E - (d - v))));
        R && "auto" === P && s > E && f > M + t + R && (M += R),
          C.width(M).height(E),
          T.width(M + t),
          (u = T.width()),
          (d = T.height()),
      ...
      _getPosition: function (t) {
        ...
        return (
          e.autoCenter && e.fixed && !t && n <= i.h && r <= i.w
            ? (s.position = "fixed")
            : e.locked || ((s.top += i.y), (s.left += i.x)),
          (s.top = g(Math.max(s.top, s.top + (i.h - n) * e.topRatio))),
          (s.left = g(Math.max(s.left, s.left + (i.w - r) * e.leftRatio))),
          s
        );
      },
      ...
      (a.transitions = {
        getOrigPosition: function () {
          ...
          return (
            ...
            u(i)
              ? ((o = i.offset()),
                i.is("img") && ((r = i.outerWidth()), (n = i.outerHeight())))
              : ((o.top = c.y + (c.h - n) * t.topRatio),
                (o.left = c.x + (c.w - r) * t.leftRatio)),
        ...
        step: function (t, e) {
          ...
          ("width" === n || "height" === n) &&
            ...
            a.isClosing && (i = 1 - i),
            (o = "width" === n ? s.wPadding : s.hPadding),
            (r = t - o),
            a.skin[n](m("width" === n ? r : r - l * i)),
            a.inner[n](m("width" === n ? r : r - l * i - c * i)));
        },
        zoomIn: function () {
          var t = a.current,
            e = t.pos,
          ...
          delete n.position,
            r
              ...
              : "fade" === o && (e.opacity = 0.1),
            a.wrap.css(e).animate(n, {
        ...
        zoomOut: function () {
          ...
          i &&
            ((o = this.getOrigPosition()), t.closeOpacity && (o.opacity = 0.1)),
            a.wrap.animate(o, {
        ...
        changeIn: function () {
          ...
          (o.opacity = 0.1),
            "elastic" === i &&
              ((t = "down" === n || "up" === n ? "top" : "left"),
              "down" === n || "right" === n
                ? ((o[t] = g(m(o[t]) - s)), (r[t] = "+=" + s + "px"))
                : ((o[t] = g(m(o[t]) + s)), (r[t] = "-=" + s + "px"))),
            "none" === i
              ? a._afterZoomIn()
              : a.wrap.css(o).animate(r, {
          ...
          (t = i.extend({}, this.defaults, t)),
            ...
            t.closeClick &&
              this.overlay.bind("click.overlay", function (t) {
                return i(t.target).hasClass("fancybox-overlay")
      ...
      (a.helpers.title = {
        ...
        beforeShow: function (t) {
          var e,
            ...
            s = t.type;
          if (
            (i.isFunction(n) && (n = n.call(r.element, r)),
            d(n) && "" !== i.trim(n))
          ) {
            switch (
              ((e = i(
      ...
      (i.fn.fancybox = function (t) {
        ...
        return (
          ...
          r && t.live !== !1
            ...
            : o.unbind("click.fb-start").bind("click.fb-start", n),
  ...
  (function (t) {
    ...
    e.helpers.buttons = {
      ...
      beforeLoad: function (t, e) {
        return t.skipSingle && e.group.length < 2
          ? ((e.helpers.buttons = !1), void (e.closeBtn = !0))
          : void (e.margin["bottom" === t.position ? 2 : 0] += 30);
      },
      ...
      onUpdate: function (t, e) {
        ...
        this.buttons &&
          ...
          e.canShrink
            ...
            : e.canExpand || i.addClass("btnDisabled"));
      },
  ...
  jQuery.extend(jQuery.easing, {
    ...
    easeOutElastic: function (t, e, i, o, r) {
      ...
      return (
        a * Math.pow(2, -10 * e) * Math.sin((2 * (e * r - n) * Math.PI) / s) +
        o +
        i
      );
    },
    ...
    easeInBack: function (t, e, i, o, r, n) {
      return (
        void 0 == n && (n = 1.70158), o * (e /= r) * e * ((n + 1) * e - n) + i
      );
    },
    easeOutBack: function (t, e, i, o, r, n) {
      return (
        void 0 == n && (n = 1.70158),
        o * ((e = e / r - 1) * e * ((n + 1) * e + n) + 1) + i
      );
    },
    easeInOutBack: function (t, e, i, o, r, n) {
      return (
        void 0 == n && (n = 1.70158),
        (e /= r / 2) < 1
          ? (o / 2) * e * e * (((n *= 1.525) + 1) * e - n) + i
          : (o / 2) * ((e -= 2) * e * (((n *= 1.525) + 1) * e + n) + 2) + i
      );
    },
    ...
    easeInOutBounce: function (t, e, i, o, r) {
      return r / 2 > e
        ? 0.5 * jQuery.easing.easeInBounce(t, 2 * e, 0, o, r) + i
        : 0.5 * jQuery.easing.easeOutBounce(t, 2 * e - r, 0, o, r) +
            0.5 * o +
            i;
    },
  }),
    ...
    return (
      (e.prototype = {
        ...
        update: function (t) {
          var e = this.genCSS(t);
          return (
            t.getAttribute("data-scrollReveal-initialized") ||
              (t.setAttribute("style", e.initial),
              t.setAttribute("data-scrollReveal-initialized", !0)),
                  ...
                  void (
                    ...
                    setTimeout(function () {
                      t.removeAttribute("style"),
                        t.setAttribute("data-scrollReveal-complete", !0);
                    }, e.totalDuration)
                  ))
                : void 0
              : void (
                  this.options.reset &&
                  t.setAttribute("style", e.initial + e.reset)
                )
          );
        },
        genCSS: function (t) {

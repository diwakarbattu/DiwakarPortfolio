    ...
    function() {
        ...
        var de = function(t) {
                if (n.vml) {
                    ...
                    a.title = "RaphaÃ«l Colour Picker", a.style.display = "none", p.body[v](a), de = i(function(t) {
        ...
        t.hsb2rgb = function(e, i, o, r) {
            ...
            return l ? (l[2] && (r = V(l[2].substring(5), 16), o = V(l[2].substring(3, 5), 16), i = V(l[2].substring(1, 3), 16)), l[3] && (r = V((s = l[3].charAt(3)) + s, 16), o = V((s = l[3].charAt(2)) + s, 16), i = V((s = l[3].charAt(1)) + s, 16)), l[4] && (a = l[4][T](oe), i = U(a[0]), "%" == a[0].slice(-1) && (i *= 2.55), o = U(a[1]), "%" == a[1].slice(-1) && (o *= 2.55), r = U(a[2]), "%" == a[2].slice(-1) && (r *= 2.55), "rgba" == l[1].toLowerCase().slice(0, 4) && (n = U(a[3])), a[3] && "%" == a[3].slice(-1) && (n /= 100)), l[5] ? (a = l[5][T](oe), i = U(a[0]), "%" == a[0].slice(-1) && (i *= 2.55), o = U(a[1]), "%" == a[1].slice(-1) && (o *= 2.55), r = U(a[2]), "%" == a[2].slice(-1) && (r *= 2.55), ("deg" == a[0].slice(-3) || "Â°" == a[0].slice(-1)) && (i /= 360), "hsba" == l[1].toLowerCase().slice(0, 4) && (n = U(a[3])), a[3] && "%" == a[3].slice(-1) && (n /= 100), t.hsb2rgb(i, o, r, n)) : l[6] ? (a = l[6][T](oe), i = U(a[0]), "%" == a[0].slice(-1) && (i *= 2.55), o = U(a[1]), "%" == a[1].slice(-1) && (o *= 2.55), r = U(a[2]), "%" == a[2].slice(-1) && (r *= 2.55), ("deg" == a[0].slice(-3) || "Â°" == a[0].slice(-1)) && (i /= 360), "hsla" == l[1].toLowerCase().slice(0, 4) && (n = U(a[3])), a[3] && "%" == a[3].slice(-1) && (n /= 100), t.hsl2rgb(i, o, r, n)) : (l = {
                r: i,
                g: o,
                b: r
        ...
        var ge = i(function(t) {
            ...
            Pe = function(t) {
                return function() {
                    throw new Error("RaphaÃ«l: you are calling to method â€œ" + t + "â€ of removed object")
                }
            };
        if (t.pathToRelative = ye, t.svg) {
            ...
            a.clear = function() {
                ...
                this.bottom = this.top = null, (this.desc = Re("desc"))[v](p.createTextNode("Created with RaphaÃ«l")), t[v](this.desc), t[v](this.defs = Re("defs"))
            }, a.remove = function() {
